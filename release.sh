# Got the following script from https://gist.github.com/nwinkler/9213085
# Thanks
#!/bin/bash
...
scmCommentPrefix='tahoe-1000: Hello World, being able to create and update data using Iceberg via Spark.'
